<template>
  <div>
     <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-yellow border-bottom box-shadow">
      <h5 class="my-0 mr-md-auto font-weight-normal">
        <img  style="height:72px;width:162px" src="~/assets/images/logo1_V1.png" />
      </h5>
      ...
      <b>{{this.$store.state.session.fistName }} {{this.$store.state.session.lastName }}</b>
   ...
   <div class="container">
     ...
     <Nuxt />
      ...
      <footer class="pt-4 pt-md-5 border-top footer">
        <div class="row">
          ...
          <div class="col-6 col-md">
            <h5 class="text-yellow">A propos</h5>
          ...
          <div class="col-6 col-md">
            <h5 class="text-yellow">Découvrir</h5>
            <ul class="list-unstyled text-small">
          ...
          <div class="col-6 col-md">
            <h5 class="text-yellow">Notre adresse</h5>
            <ul class="list-unstyled text-small">
